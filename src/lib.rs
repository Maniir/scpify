...
//! * **HiSLIP transport** *(feature `hislip`)* — [`transport::HislipClient`]
//!   and [`transport::HislipServer`] implement the IVI-6.1 HiSLIP protocol
//!   (port 4880) with credit-based flow control.
//!
//! ## Quick start
//!
//! ```rust
