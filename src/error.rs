...
/// No error.
pub const NO_ERROR: ScpiError = ScpiError {
    code: 0,
    message: "No error",
};
...
pub const COMMAND_ERROR: ScpiError = ScpiError {
    code: -100,
    message: "Command error",
};
/// Invalid character.
pub const INVALID_CHARACTER: ScpiError = ScpiError {
    code: -101,
    message: "Invalid character",
};
/// Syntax error.
pub const SYNTAX_ERROR: ScpiError = ScpiError {
    code: -102,
    message: "Syntax error",
};
/// Invalid separator.
pub const INVALID_SEPARATOR: ScpiError = ScpiError {
    code: -103,
    message: "Invalid separator",
};
/// Data type error.
pub const DATA_TYPE_ERROR: ScpiError = ScpiError {
    code: -104,
    message: "Data type error",
};
/// GET not allowed.
pub const GET_NOT_ALLOWED: ScpiError = ScpiError {
    code: -105,
    message: "GET not allowed",
};
/// Undefined header.
pub const UNDEFINED_HEADER: ScpiError = ScpiError {
    code: -113,
    message: "Undefined header",
};
/// Header suffix out of range.
pub const HEADER_SUFFIX_OUT_OF_RANGE: ScpiError = ScpiError {
    code: -114,
    message: "Header suffix out of range",
};
/// Unexpected number of parameters.
pub const UNEXPECTED_NUMBER_OF_PARAMETERS: ScpiError = ScpiError {
    code: -115,
    message: "Unexpected number of parameters",
};
/// Header not allowed.
pub const HEADER_NOT_ALLOWED: ScpiError = ScpiError {
    code: -116,
    message: "Header not allowed",
};
/// Missing parameter.
pub const MISSING_PARAMETER: ScpiError = ScpiError {
    code: -109,
    message: "Missing parameter",
};
/// Parameter not allowed.
pub const PARAMETER_NOT_ALLOWED: ScpiError = ScpiError {
    code: -108,
...
pub const EXECUTION_ERROR: ScpiError = ScpiError {
    code: -200,
    message: "Execution error",
};
/// Data out of range.
pub const DATA_OUT_OF_RANGE: ScpiError = ScpiError {
    code: -222,
    message: "Data out of range",
};
/// Hardware error.
pub const HARDWARE_ERROR: ScpiError = ScpiError {
    code: -240,
...
pub const DEVICE_SPECIFIC_ERROR: ScpiError = ScpiError {
    code: -300,
    message: "Device-specific error",
};
/// Storage fault.
pub const STORAGE_FAULT: ScpiError = ScpiError {
    code: -350,
    message: "Storage fault",
};

// Query errors (−400 to −499)
/// Query error — generic.
pub const QUERY_ERROR: ScpiError = ScpiError {
    code: -400,
    message: "Query error",
};
/// Query interrupted.
pub const QUERY_INTERRUPTED: ScpiError = ScpiError {
    code: -410,
    message: "Query INTERRUPTED",
};
/// Query unterminated.
pub const QUERY_UNTERMINATED: ScpiError = ScpiError {
    code: -420,
    message: "Query UNTERMINATED",
};
/// Query deadlocked.
pub const QUERY_DEADLOCKED: ScpiError = ScpiError {
    code: -430,
    message: "Query DEADLOCKED",
};
